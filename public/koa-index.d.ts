...
declare function compose<T1, U1, T2, U2>(
    middleware: [Application.Middleware<T1, U1>, Application.Middleware<T2, U2>]
): Application.Middleware<T1 & T2, U1 & U2>;

declare function compose<T1, U1, T2, U2, T3, U3>(
    middleware: [Application.Middleware<T1, U1>, Application.Middleware<T2, U2>, Application.Middleware<T3, U3>]
): Application.Middleware<T1 & T2 & T3, U1 & U2 & U3>;

declare function compose<T1, U1, T2, U2, T3, U3, T4, U4>(
    middleware: [Application.Middleware<T1, U1>, Application.Middleware<T2, U2>, Application.Middleware<T3, U3>, Application.Middleware<T4, U4>]
): Application.Middleware<T1 & T2 & T3 & T4, U1 & U2 & U3 & U4>;

declare function compose<T1, U1, T2, U2, T3, U3, T4, U4, T5, U5>(
    middleware: [
        Application.Middleware<T1, U1>, Application.Middleware<T2, U2>, Application.Middleware<T3, U3>, Application.Middleware<T4, U4>,
        Application.Middleware<T5, U5>
    ]
): Application.Middleware<T1 & T2 & T3 & T4 & T5, U1 & U2 & U3 & U4 & U5>;

declare function compose<T1, U1, T2, U2, T3, U3, T4, U4, T5, U5, T6, U6>(
    middleware: [
        Application.Middleware<T1, U1>, Application.Middleware<T2, U2>, Application.Middleware<T3, U3>, Application.Middleware<T4, U4>,
        Application.Middleware<T5, U5>, Application.Middleware<T6, U6>
    ]
): Application.Middleware<T1 & T2 & T3 & T4 & T5 & T6, U1 & U2 & U3 & U4 & U5 & U6>;

declare function compose<T1, U1, T2, U2, T3, U3, T4, U4, T5, U5, T6, U6, T7, U7>(
    middleware: [
        Application.Middleware<T1, U1>, Application.Middleware<T2, U2>, Application.Middleware<T3, U3>, Application.Middleware<T4, U4>,
        Application.Middleware<T5, U5>, Application.Middleware<T6, U6>, Application.Middleware<T7, U7>
    ]
): Application.Middleware<T1 & T2 & T3 & T4 & T5 & T6 & T7, U1 & U2 & U3 & U4 & U5 & U6 & U7>;

declare function compose<T1, U1, T2, U2, T3, U3, T4, U4, T5, U5, T6, U6, T7, U7, T8, U8>(
    middleware: [
        Application.Middleware<T1, U1>, Application.Middleware<T2, U2>, Application.Middleware<T3, U3>, Application.Middleware<T4, U4>,
        Application.Middleware<T5, U5>, Application.Middleware<T6, U6>, Application.Middleware<T7, U7>, Application.Middleware<T8, U8>
    ]
): Application.Middleware<T1 & T2 & T3 & T4 & T5 & T6 & T7 & T8, U1 & U2 & U3 & U4 & U5 & U6 & U7 & U8>;

declare function compose<T>(middleware: Array<compose.Middleware<T>>): compose.ComposedMiddleware<T>;

declare namespace compose {
    type Middleware<T> = (context: T, next: Application.Next) => any;
    type ComposedMiddleware<T> = (context: T, next?: Application.Next) => Promise<void>;
}
...
declare const app: Application<{ name: string, age: number }, { name: string, age: number }>;
// export = Application;

declare function exportFunction(callback: (ctx: Application.ParameterizedContext) => void): void;
